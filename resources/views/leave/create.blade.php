...
<body>
	<div>
		...
		<div class="container text-center">
			非連續日期請假，請分不同假單請假，否則假單需學務長（４日以上）校長（６日以上）簽核
			<br> 若有同學陪病 請務必輸入 陪病者 以方便陪伴的同學請【陪病假】.
			<br> 陪病者 需經由導師或輔導教官指定陪診或照顧住院同學，未經同意視同缺課。
		</div>

		<div class="container text-center py-2">
			<input type="button" value="更多">
			<input type="button" onclick="display_class()" value="課表選擇">
			...
			<table class="table table-hover table-bordered table-sm table-responsive">
				<thead>
					<tr>
						<th scope="col">序</th>
						<th scope="col">請假日期
							<div class="d-block d-lg-inline"></div>(ex:1010401)</th>
